// Netlify function to handle form submissions and send to Resend
// This runs when Netlify Forms receives a submission
...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    // If Resend is configured, add to audience and send welcome email
    ...
    // Return success - Netlify Forms will handle the submission
    return {
      statusCode: 200,
